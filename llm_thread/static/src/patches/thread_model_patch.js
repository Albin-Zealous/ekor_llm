  ...
  setActiveURL() {
    ...
    if (this.model === "llm.thread") {
      try {
        ...
        // NOTE: URL sync via @web/core/browser/router is omitted on Odoo 17
        // (that module/API is not available in this bundle). Breadcrumb /
        // action context is still kept in sync below.
